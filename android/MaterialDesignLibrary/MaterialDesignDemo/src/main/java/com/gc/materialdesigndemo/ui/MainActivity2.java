...
public class MainActivity2 extends Activity implements OnColorSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSelectColor.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				ColorSelector colorSelector = new ColorSelector(MainActivity2.this, backgroundColor, MainActivity2.this);
				colorSelector.show();
			}
		});
        ...
        layoutRipple.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(MainActivity2.this,ButtonsActivity.class);
        ...
        layoutRipple.setOnClickListener(new OnClickListener() {
        	...
        	@Override
        	public void onClick(View arg0) {
        		Intent intent = new Intent(MainActivity2.this,SwitchActivity.class);
        		intent.putExtra("BACKGROUND", backgroundColor);
        		startActivity(intent);
        	}
        });
        ...
        layoutRipple.setOnClickListener(new OnClickListener() {
        	...
        	@Override
        	public void onClick(View arg0) {
        		Intent intent = new Intent(MainActivity2.this,ProgressActivity.class);
        		intent.putExtra("BACKGROUND", backgroundColor);
        		startActivity(intent);
        	}
        });
        ...
        layoutRipple.setOnClickListener(new OnClickListener() {
        	...
        	@Override
        	public void onClick(View arg0) {
        		Intent intent = new Intent(MainActivity2.this,WidgetActivity.class);
        		intent.putExtra("BACKGROUND", backgroundColor);
        		startActivity(intent);
        	}
        });
