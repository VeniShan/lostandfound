...
<body class="login-body">
	<div class="container">
		<form class="form-signin" action="<%=basePath%>/StaffLogin.action" method="post">
			<h2 class="form-signin-heading">工作人员登录<br/>地铁失物招领-后台管理系统</h2>
			<div class="login-wrap">
				<input type="text" class="form-control" placeholder="用户名" name="userid" autofocus> 
				<input type="password" class="form-control" placeholder="密码" name="password"> 
				<label class="checkbox"> 
					<input type="checkbox" value="remember-me"> 记住我 
					<span class="pull-right"> <a href="<%=basePath%>/AdminWelcome.action"> 管理员登录</a></span>
				</label>
